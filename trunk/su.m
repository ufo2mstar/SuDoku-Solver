...
% the Sudoku is not created after 30 seconds. When the entire code is
% finished making every Sudoku, MATLAB will beep.
%
% Pressing "ctrl-c" at the command line works to stop the code if you don't
...
% be used.
%
% The output called "depth of thread" is explained in SudokuSolver.m.
%
...
% Note: Windows R2006b and Linux R2009b give same results for these seeds.
% Rerunning a seed cannot change "depth of thread" value. You must
%     instead copy the Sudoku into SudokuSolver.m.
